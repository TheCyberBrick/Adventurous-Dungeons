...
/**
 * This component returns whether one, or both input values are true
 */
public class BoolOrSC extends DungeonScriptComponent {
	private InputPort<Boolean> in_0;
	private InputPort<Boolean> in_1;
	private OutputPort<Boolean> out;

	public BoolOrSC(Script script) {
		super(script);
	}

	public BoolOrSC(Script script, String name) {
		super(script, name);
	}
