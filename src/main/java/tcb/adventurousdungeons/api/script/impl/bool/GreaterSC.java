...
/**
 * This component returns whether the first value is greater than the second
 */
public class GreaterSC extends DungeonScriptComponent {
	private InputPort<Double> in_0;
	private InputPort<Double> in_1;
	private OutputPort<Boolean> out;

	public GreaterSC(Script script) {
		super(script);
	}

	public GreaterSC(Script script, String name) {
		super(script, name);
	}
