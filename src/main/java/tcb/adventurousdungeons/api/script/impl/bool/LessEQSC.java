...
/**
 * This component returns whether the first value is less or equal the second
 */
public class LessEQSC extends DungeonScriptComponent {
	private InputPort<Double> in_0;
	private InputPort<Double> in_1;
	private OutputPort<Boolean> out;

	public LessEQSC(Script script) {
		super(script);
	}

	public LessEQSC(Script script, String name) {
		super(script, name);
	}
