...
/**
 * This component subtracts the second integer from the first
 */
public class SubIntSC extends DungeonScriptComponent {
	private InputPort<Integer> in_val1;
	private InputPort<Integer> in_val2;
	private OutputPort<Integer> out;

	public SubIntSC(Script script) {
		super(script);
	}

	public SubIntSC(Script script, String name) {
		super(script, name);
	}
