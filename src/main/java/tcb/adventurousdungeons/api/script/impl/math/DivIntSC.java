...
/**
 * This component divides the first integer by the second
 */
public class DivIntSC extends DungeonScriptComponent {
	private InputPort<Integer> in_val1;
	private InputPort<Integer> in_val2;
	private OutputPort<Integer> out;

	public DivIntSC(Script script) {
		super(script);
	}

	public DivIntSC(Script script, String name) {
		super(script, name);
	}
