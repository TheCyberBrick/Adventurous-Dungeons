...
/**
 * This component adds two integers together
 */
public class AddIntSC extends DungeonScriptComponent {
	private InputPort<Integer> in_val1;
	private InputPort<Integer> in_val2;
	private OutputPort<Integer> out;

	public AddIntSC(Script script) {
		super(script);
	}

	public AddIntSC(Script script, String name) {
		super(script, name);
	}
