...
/**
 * This component divides the first double by the second
 */
public class DivDoubleSC extends DungeonScriptComponent {
	private InputPort<Double> in_val1;
	private InputPort<Double> in_val2;
	private OutputPort<Double> out;

	public DivDoubleSC(Script script) {
		super(script);
	}

	public DivDoubleSC(Script script, String name) {
		super(script, name);
	}
