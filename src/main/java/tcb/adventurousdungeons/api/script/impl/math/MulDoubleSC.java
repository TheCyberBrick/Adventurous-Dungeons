...
/**
 * This component multiplies two doubles together
 */
public class MulDoubleSC extends DungeonScriptComponent {
	private InputPort<Double> in_val1;
	private InputPort<Double> in_val2;
	private OutputPort<Double> out;

	public MulDoubleSC(Script script) {
		super(script);
	}

	public MulDoubleSC(Script script, String name) {
		super(script, name);
	}
