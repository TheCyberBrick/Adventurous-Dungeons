...
import tcb.adventurousdungeons.util.text.TextContainer.RangedTag;
import tcb.adventurousdungeons.util.text.TextContainer.Tag;
import tcb.adventurousdungeons.util.text.TextContainer.TextArea;
import tcb.adventurousdungeons.util.text.TextContainer.TooltipArea;

public class TextFormatTags {
